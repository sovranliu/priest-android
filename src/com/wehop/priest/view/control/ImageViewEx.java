...
public class ImageViewEx extends View implements Observer {
    ...
    protected void onDraw(Canvas canvas) {
        if (mBitmap != null && mState != null) {
            ...
            Log.d("ImageViewEx", "viewWidth = " + viewWidth);
            Log.d("ImageViewEx", "viewHeight = " + viewHeight);
            Log.d("ImageViewEx", "bitmapWidth = " + bitmapWidth);
            Log.d("ImageViewEx", "bitmapHeight = " + bitmapHeight);
            ...
            Log.d("ImageViewEx", "mRectSrc.top" + mRectSrc.top);
            Log.d("ImageViewEx", "mRectSrc.bottom" + mRectSrc.bottom);
            Log.d("ImageViewEx", "mRectSrc.left" + mRectSrc.left);
            Log.d("ImageViewEx", "mRectSrc.right" + mRectSrc.right);

            Log.d("ImageViewEx", "mRectDst.top" + mRectDst.top);
            Log.d("ImageViewEx", "mRectDst.bottom" + mRectDst.bottom);
            Log.d("ImageViewEx", "mRectDst.left" + mRectDst.left);
            Log.d("ImageViewEx", "mRectDst.right" + mRectDst.right);
